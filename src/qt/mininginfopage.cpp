    ...
    ui(new Ui::MiningInfoPage)
{
    ...
    // set the pens
    //a13469
    ui->diffplot_difficulty->graph(0)->setPen(QPen(QColor("#d2a631"), 3, Qt::SolidLine, Qt::SquareCap, Qt::BevelJoin));//QPen(QColor(76, 76, 229)));
    ...
    //a13469, 6c3d94
    //ab841b
    ui->diffplot_hashrate->graph(0)->setPen(QPen(QColor("#ab841b"), 3, Qt::SolidLine, Qt::SquareCap, Qt::BevelJoin));//QPen(QColor(76, 76, 229)));

...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->displayTicker, OptionsModel::DisplayTicker);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting ZillionCoin."), QMessageBox::Ok);

...
extern int vanity_gettimeofday(struct timeval *tv, struct timezone *tz);
...
typedef int (*vg_add_pattern_func_t)(vg_context_t *, const char ** const patterns,  int npatterns);
//typedef int (*vg_add_pattern_func_t)(vg_context_t *, char ** patterns,  int npatterns);
...
typedef void (*vg_output_match_func_t)(vg_context_t *vcp, EC_KEY *pkey,
                                       const char *pattern);
typedef void (*vg_output_timing_func_t)(unsigned long long rate, unsigned long long total);
...
extern int vg_context_add_patterns(vg_context_t *vcp,  const char ** const patterns, int npatterns);
...
extern void vg_output_match_console(vg_context_t *vcp, EC_KEY *pkey,
                                    const char *pattern);
extern void vg_output_timing_console(unsigned long long rate,unsigned long long total);

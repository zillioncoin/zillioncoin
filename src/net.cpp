...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ZillionCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zillioncoin.net", "dnsseed.zillioncoin.net"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    ...
    0x68A9232D, 0x6CA9232D, 0x03F92305,
    0xCEFD2305, 0x9C713A4D, 0xA411A51F,
    0x5C7D26B2,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ZillionCoin is probably already running."), addrBind.ToString().c_str());
        else

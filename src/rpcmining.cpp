...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty() && !fTestNet)
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "ZillionCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "ZillionCoin is downloading blocks...");
